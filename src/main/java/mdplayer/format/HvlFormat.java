...
import mdplayer.plugin.HvlPlugin;
...
/**
 * HVL (HivelyTracker, Amiga) FileFormat.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-07-03 nsano initial version <br>
 */
public class HvlFormat extends BaseFileFormat {

    @Override
    public String[] getExtensions() {
        return new String[] {".hvl"};
    }
    ...
    public Encoding getEncoding() {
        return new MdEncoding("HVL", "hvl");
    }

    @Override
    public Type getType() {
        return new MdFileFormatType("HVL", "hvl");
    }
