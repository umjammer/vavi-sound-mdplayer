...
/**
 * The gaussian interpolation table the SPU resamples with.
 * <p>
 * ported from aosdk eng_psf/peops/gauss_i.h, which kode54 generated by interleaving the
 * table libopenspc logged from an SPC-700 - Neill Corlett says the same curve comes off a
 * PSX SPU. The coefficients are interleaved four to a step, which is why the table is 1024
 * entries for 256 fractional positions.
 *
