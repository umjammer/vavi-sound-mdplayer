...
logger.log(Level.WARNING, "cannot start: " + this);
    ...
    boolean nsfPlay() {
        try {
            ...
            IntFNesInst apu = Instrument.getInstrument(IntFNesInst.class);
            ...
            chip.clock = 0;
            chip.option = null;
            chip.volume = setting.getBalance().getVolume(MAIN_TAG, IntFNesInst.MMC5.class);
            lstChips.add(chip);
            ...
            chip.clock = 0;
            chip.option = null;
            chip.volume = setting.getBalance().getVolume(MAIN_TAG, IntFNesInst.N160.class);
            lstChips.add(chip);
            ...
            chip.clock = 0;
            chip.option = null;
            chip.volume = setting.getBalance().getVolume(MAIN_TAG, IntFNesInst.VRC6.class);
            lstChips.add(chip);
            ...
            chip.clock = 0;
            chip.option = null;
            chip.volume = setting.getBalance().getVolume(MAIN_TAG, IntFNesInst.VRC7.class);
            lstChips.add(chip);
            ...
            chip.clock = 0;
            chip.option = null;
            chip.volume = setting.getBalance().getVolume(MAIN_TAG, IntFNesInst.FME7.class);
            lstChips.add(chip);
