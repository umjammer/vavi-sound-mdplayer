 ...
 */
public class NesChip2 implements Chip {

    private static final Logger logger = getLogger(NesChip2.class.getName());
...
//        else reg = apu.apu.reg;
        ...
        // for vgm
//        if (reg == null) reg = readApu(chipId, EnmModel.VirtualModel);
...
//            else reg = dmc.dmc.reg;
            ...
            // for vgm
//            if (reg == null) reg = readDmc(chipId, EnmModel.VirtualModel);
...
//        else reg = fds.fds;
        ...
        // for vgm
//        if (reg == null) reg = readFds(chipId, EnmModel.VirtualModel);
