 ...
 */
public class SmafFileFormat extends BaseFileFormat {
    ...
    public String[] getPresetMixerBalance() {
        return new String[] {"DriverBalance_SMAF.mbc", "/resources/DefaultVolumeBalance_SMAF.xml"};
    }

    @Override
    public Plugin getPlugin() {
        return Plugin.getPlugin(SmafPlugin.class);
    }

    @Override
    public Encoding getEncoding() {
        return new MdEncoding("SMAF", "mmf");
    }

    @Override
    public Type getType() {
        return new MdFileFormatType("SMAF", "mmf");
    }
    ...
    public boolean isSupported(InputStream is) throws IOException {
        ...
        if (r < 4) return false;
        return header[0] == 'M' && header[1] == 'M' && header[2] == 'M' && header[3] == 'D';
    }
}
