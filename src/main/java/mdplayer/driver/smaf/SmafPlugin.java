 ...
 */
public class SmafPlugin extends BasePlugin<SmafDriver> {

    @Override
    public void prepare() {
        driverVirtual = new SmafDriver(this);
    ...
    protected void initChips() {
        // the emulated player renders the audio itself, so no mdsound chip is registered
