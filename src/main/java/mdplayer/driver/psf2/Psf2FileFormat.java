...
/**
 * PSF2 (Sony PlayStation 2) FileFormat.
 *
 * @author <a href="mailto:umjammer@gmail.com">Naohide Sano</a> (nsano)
 * @version 0.00 2026-08-09 nsano initial version <br>
 */
public class Psf2FileFormat extends BaseFileFormat {

    @Override
    public String[] getExtensions() {
        return new String[] {".psf2", ".minipsf2"};
    }
    ...
    /**
     * A ".minipsf2" holds only its own filesystem and names the one with the samples and the
     * driver modules in its "_lib" tags.
     */
    @Override
    ...
    public String[] getPresetMixerBalance() {
        return new String[] {"DriverBalance_PSF2.mbc", "/resources/DefaultVolumeBalance_PSF2.xml"};
    }

    @Override
    public Plugin getPlugin() {
        return Plugin.getPlugin(Psf2Plugin.class);
    }

    @Override
    public Encoding getEncoding() {
        return new MdEncoding("PSF2", "psf2");
    }

    @Override
    public Type getType() {
        return new MdFileFormatType("PSF2", "psf2");
    }
    ...
    public boolean isSupported(InputStream is) throws IOException {
        ...
        if (r < 4) return false;
        return header[0] == 'P' && header[1] == 'S' && header[2] == 'F' && (header[3] & 0xff) == 2;
    }
}
