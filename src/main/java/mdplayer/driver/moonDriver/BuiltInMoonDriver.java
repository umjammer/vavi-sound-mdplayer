...
@Deprecated
public class BuiltInMoonDriver extends BaseDriver {
...
//        public int IDX_OLDAT1 = 17;   // equ(seq_ch1_ar_d1r  - seq_work); Volume data for 1stOP
    ...
    private static final int[] fm_fnumtbl = {
            345, // C 523.300000
            365, // C+ 554.400000
            387, // D 587.300000
            410, // D+ 622.300000
    ...
    private static final int[] fm_testtone = {
            0x00, // FBS
            0x00, // FBS2
            0x00, // BD
    ...
    private static final int[] fm_op2reg_tbl = {
            0x00, // 0
            0x01, //
            0x02, // 2
            0x03, //
    ...
    private static final int[] fm_opbtbl = {
            0x00, // CH0
            0x01, // CH1
            0x02, // CH2
            0x06, // CH3
    ...
    //
    // BSMCH
    private static final int[] fm_drum_fnum = {
            0x0120, // B
            0x0150, // s
            0x01c0, // M
            0x01c0, // C
    ...
    private static final int[] fm_drum_fnum_map = {
            0x06, // B
            0x07, // s
            0x08, // M
            0x08, // C
    ...
    private static final int[] fm_drum_oct = {
            0x02, // B
            0x02, // s
            0x00, // M
            0x00, // C
...
//        a = (a >> 1) + ((a & 1) != 0 ? 0x80 : 0);
    ...
    private void moon_fm1_out() {
        ...
        // ret
        if (isOPL3) {
            plugin.chipRegister.chip(YmF262Chip.class).write(0, 0, d & 0xff, e & 0xff, model);
        } else {
            plugin.chipRegister.chip(YmF278BChip.class).write(0, 0, d & 0xff, e & 0xff, model);
    ...
    private void moon_fm2_out() {
        ...
        // ret
        if (isOPL3) {
            plugin.chipRegister.chip(YmF262Chip.class).write(0, 1, d & 0xff, e & 0xff, model);
        } else {
            plugin.chipRegister.chip(YmF278BChip.class).write(0, 1, d & 0xff, e & 0xff, model);
        }
    ...
    private void moon_wave_out() {
        ...
        if (isOPL3) {
            ...
            plugin.chipRegister.chip(YmF278BChip.class).write(0, 2, d & 0xff, e & 0xff, model);
        }
