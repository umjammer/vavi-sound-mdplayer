...
import java.util.Map;
    ...
    public class romCheck
    {
        ...
        //private HashMap<String, byte[]> md5map;

        /**
         //Maps checksums to respective ROM description.
         //Must be filled by derived class.
         */
        private Map<String, String> m_checksums=new HashMap<>();
     ...
     */
    class kernalCheck extends romCheck
    {
        public kernalCheck(byte[] kernal) {
        super(kernal, 0x2000);
     ...
     */
    class basicCheck extends romCheck
    {
        public basicCheck(byte[] basic) {
        super(basic, 0x2000);
     ...
     */
    class chargenCheck extends romCheck
    {
        public chargenCheck(byte[] chargen) {
