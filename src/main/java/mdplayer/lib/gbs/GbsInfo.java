...
public class GbsInfo {
    ...
    public static GbsInfo factory(byte[] b) {
        // IdentifierCheck
        ...
        info.title = new String(b, 0x10, 32, charset).replace("\0", "");
        info.author = new String(b, 0x30, 32, charset).replace("\0", "");
        info.copyright = new String(b, 0x50, 32, charset).replace("\0", "");
