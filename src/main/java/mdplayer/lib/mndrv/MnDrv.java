...
import mdplayer.lib.mndrv.MnWork.Cw;
...
public class MnDrv {
    ...
    public QuadConsumer<Integer, Integer, Integer, Integer> ym2608Write;
    ...
    public void init(byte[] data, boolean isRealModel, int sampleRate) {
