...
public class Xgm {
    ...
    public boolean existGD3 = false;
    private boolean multiTrackFile = false;
    public int gd3InfoStartAddr = 0;

    public byte[] xgmBuf;
    public Runnable stop;
    public Runnable updateMetaData;
    ...
    public void getXGMInfo(byte[] dataBuf) {
    ...
    public double pcmStep; // setting.getoutputDevice().SampleRate / 14000.0;
