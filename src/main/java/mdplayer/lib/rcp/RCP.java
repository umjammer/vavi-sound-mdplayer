...
public class RCP {
    ...
    private final EventHandler[] specialEventFunc = new EventHandler[256];
    ...
    public static Boolean checkHeadString(byte[] buf, Charset charset) {
...
logger.log(Level.INFO, "checkHeadString");
    ...
    private void headerRcp() {
        ...
        // TONENAME.TB?
        // Ignored for now
        ptr = 0x206; // Up to the rhythm definition section
    }
...
//        ps.Tempo = 60000000 / Tempo;
    ...
    public static class CtlSysex implements MID.Sysex {
