...
public class S98 {
    ...
    public double musicStep = 1; // setting.getoutputDevice().SampleRate / 60.0;
    ...
    public TriConsumer<Integer, Integer, Integer> writeYM2203;
    public QuadConsumer<Integer, Integer, Integer, Integer> writeYM2612;
    public QuadConsumer<Integer, Integer, Integer, Integer> writeYM2608;
    public QuadConsumer<Integer, Integer, Integer, Integer> writeYM2151;
    public TriConsumer<Integer, Integer, Integer> writeYM2413;
    public TriConsumer<Integer, Integer, Integer> writeYM3526;
    public TriConsumer<Integer, Integer, Integer> writeYM3812;
    public TriConsumer<Integer, Integer, Integer> writeAY8910;
    public BiConsumer<Integer, Integer> writeSN76489;
    public QuadConsumer<Integer, Integer, Integer, Integer> writeYMF262;

    public boolean getInformationHeader(byte[] data) {
...
//                        }
    ...
    private static int getVv(byte[] buf, /* ref */ int[] musicPtr) {
        int s = 0, n = 0;
