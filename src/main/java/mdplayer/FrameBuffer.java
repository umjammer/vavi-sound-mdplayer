...
public class FrameBuffer {
    ...
    public void Add(JPanel pbScreen, BufferedImage initialImage, BiConsumer<Object, PaintEventArgs> p, int zoom) {
        this.zoom = zoom;
    ...
    public void Remove(BiConsumer<Object, PaintEventArgs> p) {
        if (bmpPlane != null) {
            bmpPlane.Dispose();
            bmpPlane = null;
        }
