...
import mdplayer.chips.QSoundChip.Params;
...
public class FormQSound extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormQSound.class);

    public FormQSound(FormMain frm, int chipId, int zoom, QSoundChip.Params newParam, QSoundChip.Params oldParam) {
