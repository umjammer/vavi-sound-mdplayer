...
import mdplayer.chips.K053260Chip.Params;
...
import static mdplayer.form.kb.pcm.FormC352.drawChC352_P;


public class FormK053260 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormK053260.class);

    public FormK053260(FormMain frm, int chipId, int zoom, K053260Chip.Params newParam, K053260Chip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new K053260Chip.Params());
