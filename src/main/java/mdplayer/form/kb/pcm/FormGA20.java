...
import mdplayer.chips.Ga20Chip.Params;
...
import static mdplayer.form.kb.pcm.FormC352.drawChC352;


public class FormGA20 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormGA20.class);

    public FormGA20(FormMain frm, int chipId, int zoom, Ga20Chip.Params newParam, Ga20Chip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new Ga20Chip.Params());
