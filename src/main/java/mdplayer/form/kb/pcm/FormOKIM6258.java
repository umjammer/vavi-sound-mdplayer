...
import mdplayer.chips.OkiM6258Chip.Params;
...
public class FormOKIM6258 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormOKIM6258.class);

    public FormOKIM6258(FormMain frm, int chipId, int zoom, OkiM6258Chip.Params newParam) {
        super(frm, chipId, zoom, newParam, new OkiM6258Chip.Params());
    ...
    public void drawScreenParams() {
        OkiM6258Chip.Params ost = oldParam;
        OkiM6258Chip.Params nst = newParam;
