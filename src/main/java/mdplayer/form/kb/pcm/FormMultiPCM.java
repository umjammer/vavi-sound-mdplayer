...
import mdplayer.chips.MultiPcmChip.Params;
...
public class FormMultiPCM extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormMultiPCM.class);

    public FormMultiPCM(FormMain frm, int chipId, int zoom, MultiPcmChip.Params newParam, MultiPcmChip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new MultiPcmChip.Params());
