...
import mdplayer.chips.K054539Chip.Params;
...
public class FormK054539 extends FormChipBase<Params> {
    ...
    public FormK054539(FormMain frm, int chipId, int zoom, K054539Chip.Params newParam, K054539Chip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new K054539Chip.Params());
