...
import mdplayer.chips.Rf5C164Chip.Params;
...
public class FormMegaCD extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormMegaCD.class);

    public FormMegaCD(FormMain frm, int chipId, int zoom, Rf5C164Chip.Params newParam, Rf5C164Chip.Params oldParam) {
