...
import mdplayer.chips.Ym2610Chip.Params;
...
public class FormYM2610 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYM2610.class);

    public FormYM2610(FormMain frm, int chipId, int zoom, Ym2610Chip.Params newParam, Ym2610Chip.Params oldParam) {
