...
import mdplayer.chips.Ym2612Chip.Params;
...
public class FormYM2612 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYM2612.class);

    public FormYM2612(FormMain frm, int chipId, int zoom, Ym2612Chip.Params newParam, Ym2612Chip.Params oldParam) {
