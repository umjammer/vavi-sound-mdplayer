...
import mdplayer.chips.Ym2203Chip.Params;
...
public class FormYM2203 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYM2203.class);

    public FormYM2203(FormMain frm, int chipId, int zoom, Ym2203Chip.Params newParam, Ym2203Chip.Params oldParam) {
