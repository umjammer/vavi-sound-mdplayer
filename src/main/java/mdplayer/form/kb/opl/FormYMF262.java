...
import mdplayer.chips.YmF262Chip.Params;
...
public class FormYMF262 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYMF262.class);

    public FormYMF262(FormMain frm, int chipId, int zoom, YmF262Chip.Params newParam, YmF262Chip.Params oldParam) {
