...
import mdplayer.chips.Ym3812Chip.Params;
...
public class FormYM3812 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYM3812.class);

    public FormYM3812(FormMain frm, int chipId, int zoom, Ym3812Chip.Params newParam, Ym3812Chip.Params oldParam) {
