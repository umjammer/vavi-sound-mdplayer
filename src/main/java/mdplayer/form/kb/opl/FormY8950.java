...
import mdplayer.chips.Y8950Chip.Params;
...
public class FormY8950 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormY8950.class);

    public FormY8950(FormMain frm, int chipId, int zoom, Y8950Chip.Params newParam) {
        super(frm, chipId, zoom, newParam, new Y8950Chip.Params());
        initializeComponent();
