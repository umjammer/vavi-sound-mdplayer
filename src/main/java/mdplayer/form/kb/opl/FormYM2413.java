...
import mdplayer.chips.Ym2413Chip.Params;
...
public class FormYM2413 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYM2413.class);

    public FormYM2413(FormMain frm, int chipId, int zoom, Ym2413Chip.Params newParam, Ym2413Chip.Params oldParam) {
