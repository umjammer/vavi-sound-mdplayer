...
import mdplayer.chips.YmF278BChip.Params;
...
public class FormYMF278B extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYMF278B.class);

    public FormYMF278B(FormMain frm, int chipId, int zoom, YmF278BChip.Params newParam) {
        super(frm, chipId, zoom, newParam, new YmF278BChip.Params());
        initializeComponent();
