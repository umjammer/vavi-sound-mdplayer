...
import mdplayer.chips.YmZ280BChip.Params;
import mdplayer.form.ScreenPanel;
import mdplayer.chips.YmZ280BChip;
import mdplayer.form.sys.FormMain;


public class FormYMZ280B extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormYMZ280B.class);

    public FormYMZ280B(FormMain frm, int chipId, int zoom, YmZ280BChip.Params newParam, YmZ280BChip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new YmZ280BChip.Params());
