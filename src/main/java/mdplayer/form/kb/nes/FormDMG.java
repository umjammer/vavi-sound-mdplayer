...
import mdplayer.chips.DmgChip.Params;
...
public class FormDMG extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormDMG.class);

    public FormDMG(FormMain frm, int chipId, int zoom, DmgChip.Params newParam, DmgChip.Params oldParam) {
