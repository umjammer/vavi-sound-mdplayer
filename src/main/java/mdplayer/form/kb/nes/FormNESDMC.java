...
import mdplayer.chips.NpNesChip.DmcChip.Params;
...
public class FormNESDMC extends FormChipBase<Params> {

    //

    static final Preferences prefs = Preferences.userNodeForPackage(FormNESDMC.class);

    public FormNESDMC(FormMain frm, int chipId, int zoom, NpNesChip.DmcChip.Params newParam) {
        super(frm, chipId, zoom, newParam, new NpNesChip.DmcChip.Params());
