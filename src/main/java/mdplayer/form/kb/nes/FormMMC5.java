...
import mdplayer.chips.NpNesChip.Mmc5Chip.Params;
...
public class FormMMC5 extends FormChipBase<Params> {

    //

    static final Preferences prefs = Preferences.userNodeForPackage(FormMMC5.class);

    public FormMMC5(FormMain frm, int chipId, int zoom, NpNesChip.Mmc5Chip.Params newParam) {
        super(frm, chipId, zoom, newParam, new NpNesChip.Mmc5Chip.Params());
