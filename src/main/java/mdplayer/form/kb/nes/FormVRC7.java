...
import mdplayer.chips.NpNesChip.Vrc7Chip.Params;
...
public class FormVRC7 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormVRC7.class);

    public FormVRC7(FormMain frm, int chipId, int zoom, NpNesChip.Vrc7Chip.Params newParam) {
        super(frm, chipId, zoom, newParam, new NpNesChip.Vrc7Chip.Params());
