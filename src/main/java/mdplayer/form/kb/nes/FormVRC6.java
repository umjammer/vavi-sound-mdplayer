...
import mdplayer.chips.NpNesChip.Vrc6Chip.Params;
...
public class FormVRC6 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormVRC6.class);

    public FormVRC6(FormMain frm, int chipId, int zoom, NpNesChip.Vrc6Chip.Params newParam, NpNesChip.Vrc6Chip.Params oldParam) {
