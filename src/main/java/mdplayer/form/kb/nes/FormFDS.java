...
import mdplayer.chips.NpNesChip.FdsChip.Params;
...
public class FormFDS extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormFDS.class);

    public FormFDS(FormMain frm, int chipId, int zoom, NpNesChip.FdsChip.Params newParam) {
        super(frm, chipId, zoom, newParam, new NpNesChip.FdsChip.Params());
