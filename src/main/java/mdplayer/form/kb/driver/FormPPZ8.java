...
import mdplayer.chips.Ppz8Chip.Params;
...
public class FormPPZ8 extends FormChipBase<Params> {

    static final Preferences prefs = Preferences.userNodeForPackage(FormPPZ8.class);

    public FormPPZ8(FormMain frm, int chipId, int zoom, Ppz8Chip.Params newParam, Ppz8Chip.Params oldParam) {
        super(frm, chipId, zoom, newParam, new Ppz8Chip.Params());
