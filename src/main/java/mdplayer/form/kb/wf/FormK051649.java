...
import mdplayer.chips.K051649Chip.Params;
...
public class FormK051649 extends FormChipBase<Params> {
    ...
    public FormK051649(FormMain frm, int chipId, int zoom, K051649Chip.Params newParam) {
        super(frm, chipId, zoom, newParam, new K051649Chip.Params());
