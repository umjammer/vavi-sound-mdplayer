...
import mdplayer.chips.HuC6280Chip.Params;
...
public class FormHuC6280 extends FormChipBase<Params> {
    ...
    public FormHuC6280(FormMain frm, int chipId, int zoom, HuC6280Chip.Params newParam, HuC6280Chip.Params oldParam) {
