...
public abstract class Tables {
    ...
    public static final int[] FmFNum = new int[] {
    ...
    public static final int[] PsgFNum = new int[] {
    ...
    public static final float[] freqTbl = new float[] {
    ...
    public static final float[] pcmMulTbl = new float[] {
        1.0f/2.0f
    ...
    public static final String[][] tblMIDIEffectGS = new String[][] {
    ...
    public static final String[][] tblMIDIEffectXG = new String[][] {
        new String[] {
    ...
    public static final String[] tblMIDIInstrumentGM = new String[] {
    ...
    public static final byte[] spc = new byte[] {
